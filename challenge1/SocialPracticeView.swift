...
struct SocialPracticeView : View {
    ...
    var body: some View {
        ...
        PracticeContent(
            ...
            Engaging in community activities can be a powerful way to combat social isolation and loneliness.\n
            Here are steps to help someone effectively engage with their community:
            """,
            steps: ["Join a local club or group", "Attend community events", "Volunteer for local organizations", "Visualize Your Desired Outcome","Imagine Overcoming Obstacles","Focus on Your Next Steps","Repeat and Reinforce"],
